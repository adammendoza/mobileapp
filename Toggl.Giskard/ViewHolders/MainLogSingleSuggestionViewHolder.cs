...
{
    public sealed class MainLogSingleSuggestionViewHolder : BaseRecyclerViewHolder<Suggestion>
    {
        ...
        public MainLogSingleSuggestionViewHolder(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {
        }

        public MainLogSingleSuggestionViewHolder(View itemView, int firstItemMargin, int lastItemMargin, int defaultCardSize) : base(itemView)
        {
