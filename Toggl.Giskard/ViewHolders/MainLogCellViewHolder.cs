...
namespace Toggl.Giskard.ViewHolders
{
    public class MainLogCellViewHolder : BaseRecyclerViewHolder<TimeEntryViewModel>
    {
        ...
        {
            changeSwipeBackgroundsVisibility(true, false);
        }

        public void ShowSwipeToDeleteBackground()
        {
            changeSwipeBackgroundsVisibility(false, true);
        }

        public void HideSwipeBackgrounds()
        {
            changeSwipeBackgroundsVisibility(false, false);
        }
        ...
        //todo: improve project related code duplication
        ...
        private void changeSwipeBackgroundsVisibility(bool continueBackgroundVisibility, bool deleteBackgroundVisibility)
        {
            mainLogBackgroundContinue.Visibility = continueBackgroundVisibility.ToVisibility();
            mainLogBackgroundDelete.Visibility = deleteBackgroundVisibility.ToVisibility();
        }
