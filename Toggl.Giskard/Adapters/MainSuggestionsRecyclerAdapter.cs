...
namespace Toggl.Giskard.Adapters
{
    public class MainSuggestionsRecyclerAdapter : RecyclerView.Adapter
    {
        ...
        private ImmutableList<Suggestion> currentSuggestions;
        ...
        public MainSuggestionsRecyclerAdapter()
        {
            currentSuggestions = ImmutableList<Suggestion>.Empty;
        }
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            var suggestionsViewHolder = (MainLogSingleSuggestionViewHolder) holder;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            return new MainLogSingleSuggestionViewHolder(view, firstItemMargin, lastItemMargin, defaultCardSize)
            {
